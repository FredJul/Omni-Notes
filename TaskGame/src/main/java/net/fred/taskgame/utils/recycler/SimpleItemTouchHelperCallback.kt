 ...
 */
class SimpleItemTouchHelperCallback(private val adapter: ItemActionAdapter) : ItemTouchHelper.Callback() {
    ...
    override fun onSelectedChanged(viewHolder: RecyclerView.ViewHolder?, actionState: Int) {
        ...
        if (actionState == ItemTouchHelper.ACTION_STATE_DRAG) {
            ...
            val itemViewHolder = viewHolder as ItemActionViewHolder?
