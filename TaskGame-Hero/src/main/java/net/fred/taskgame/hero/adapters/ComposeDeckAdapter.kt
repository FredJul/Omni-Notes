...
class ComposeDeckAdapter(val cards: List<Card>, private val mItemListener: RecyclerViewItemListener) : RecyclerView.Adapter<ComposeDeckAdapter.CardViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CardViewHolder {
        ...
        val v = inflater.inflate(R.layout.item_deck_card, parent, false)
    ...
    override fun onBindViewHolder(holder: CardViewHolder, position: Int) {
        ...
        holder.itemView.card.setBackgroundResource(if (card.isInDeck) R.drawable.selected_rounded_background else 0)

        holder.itemView.card.onClick { mItemListener.onItemClicked(holder.adapterPosition) }
    }
